          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 auto-rows-auto">
            {services.map((svc, i) => (
              <motion.div key={svc.title} {...stagger} transition={{ duration: 0.5, delay: i * 0.1 }} className={`${svc.span}`}>
                <Link to="/services" data-testid={`service-card-${i}`} className="block bg-white rounded-2xl border border-slate-100 overflow-hidden group hover:shadow-xl hover:border-green-400/30 transition-all duration-300 h-full">
